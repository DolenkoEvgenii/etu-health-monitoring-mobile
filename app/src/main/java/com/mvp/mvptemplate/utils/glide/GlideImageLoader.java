package com.mvp.mvptemplate.utils.glide;
...
public class GlideImageLoader {
    ...
    public void load(final String url, RequestOptions options, RequestListener<Drawable> listener) {
        ...
        //Get Image
        RequestBuilder<Drawable> builder = Glide.with(mImageView.getContext())
                .load(url)
